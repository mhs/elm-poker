...
module PokerApi.Mutation exposing (CloseRoundRequiredArguments, CreateGameRequiredArguments, DeleteGameRequiredArguments, JoinGameRequiredArguments, LeaveGameRequiredArguments, LoginRequiredArguments, NextRoundRequiredArguments, UpdateEstimateOptionalArguments, UpdateEstimateRequiredArguments, closeRound, createGame, deleteGame, joinGame, leaveGame, login, nextRound, selection, updateEstimate)
